...
set verbose=0		" verboselevel to show startup/exit vim processes, default: 10.
set more			" show '--more--' in listings
set ts=4			" tabstop = tabwidth
...
set foldcolumn=6	" shows a fold column on the lest (symbols: +. -, |)
